<!--  ขอความอนุเคราะห์ดำเนินการเพิ่มตารางภาคปฏิบัติสอบปลายภาค ประจำภาคเรียนที่ 1/2566 (เพิ่มเติม) -->
<?php
session_start();
  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="doc-row">
        ...
        <div class="dot-line">
          <span class="chip" contenteditable="true">
            ขอความอนุเคราะห์ดำเนินการเพิ่มตารางภาคปฏิบัติ
            สอบปลายภาค ประจำภาคเรียนที่ 1/2566 (เพิ่มเติม)
          </span>
        </div>
      </div>
      ...
      <div class="content-block paragraph">
        ด้วยข้าพเจ้า
        <span class="chip" contenteditable="true">ผู้ช่วยศาสตราจารย์นิติการ นาคเจือทอง</span>
        อาจารย์ประจำภาควิชาเทคโนโลยีสารสนเทศ
        คณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มีความประสงค์ขอความอนุเคราะห์ดำเนินการเพิ่มตารางสอบปลายภาค
        ประจำภาคเรียนที่
        <span class="chip" contenteditable="true">1/2566</span>
        (เพิ่มเติม)
        จำนวน
        <span class="chip" contenteditable="true">2</span>
        วิชา
        เพื่ออำนวยความสะดวกในการจัดการสอบภาคปฏิบัติ
      </div>


      <!-- ย่อหน้า 2 -->
      <table width="100%" cellpadding="6" cellspacing="0"
        style="border:2px solid black !important; border-collapse:collapse !important; margin-top:1em;">

        <tr align="center">
          <th style="border:1px solid black !important;">รายวิชา</th>
          <th style="border:1px solid black !important;">ผู้สอน</th>
          <th style="border:1px solid black !important;">ตอนเรียนที่</th>
          <th style="border:1px solid black !important;">
            ตารางสอบปลายภาค 1/2566<br>ขอเพิ่มตารางสอบปฏิบัติ
          </th>
        </tr>

        <!-- วิชา 1 -->
        <tr>
          <td rowspan="1" style="border:1px solid black !important;">
            1. 060233101 Introduction to<br>
            Information and Network Engineering
          </td>
          <td align="center" style="border:1px solid black !important;">NKT</td>
          <td align="center" style="border:1px solid black !important;">L.1</td>
          <td align="center" style="border:1px solid black !important;">
            ศ. 27/10/2566 13.00–16.00
          </td>
        </tr>

        <!-- วิชา 2 (รวมเป็นช่องเดียว ไม่มีเส้นคั่น) -->
        <tr>
          <td style="border:1px solid black !important;">
            2. 060243101 Fundamental of<br>
            Information Technology
          </td>

          <td align="center" style="border:1px solid black !important; line-height:1.8;">
            SLJ<br>
            SLJ<br>
            NKT
          </td>
      ...
      <!-- ย่อหน้า 3 -->
      <div class="content-block paragraph">
        จึงเรียนมาเพื่อโปรดให้ความอนุเคราะห์และดำเนินการต่อไป
        จักขอบคุณยิ่ง
      </div>
      ...
      <div class="signature-wrapper">
        <div class="signature-block" id="signatureBlock">
          <div class="sig-name">(ผู้ช่วยศาสตราจารย์นิติการ นาคเจือทอง)</div>
          <div class="sig-position">อาจารย์ประจำภาควิชาเทคโนโลยีสารสนเทศ</div>
        </div>
      </div>

      <!-- เรียน -->
      <div class="content-block single" style="margin-top:1.5em;">
        เรียน รองคณบดีฝ่ายวิชาการ
      </div>

      <div class="content-block single" style="margin-left:0.8cm;">
        เพื่อโปรดพิจารณาอนุมัติ
      </div>


      <!-- ลายเซ็นผู้รับรอง -->
      <div style="margin-top:3em; text-align:left; font-family:'TH SarabunPSK'; font-size:16pt;">
        <div>(ผู้ช่วยศาสตราจารย์ ดร.ชนัฐชา นามี)</div>
        <div>หัวหน้าภาควิชาเทคโนโลยีสารสนเทศ</div>
      </div>
