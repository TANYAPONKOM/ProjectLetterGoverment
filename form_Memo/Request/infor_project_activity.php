...
?>
<!--"ขอเข้าไปจัดกิจกรรมโครงการ", "/Pro_letter/form_Memo/Request/infor_project_activity.php" -->
<?php
session_start();
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">1. เรื่อง :</label>
        <div class="flex-1">
          <input type="text" name="subject" id="subjectInput" data-spell-field="subject"
            class="w-full border rounded-md p-2"
            placeholder="เรื่องเช่น ขออนุญาตดำเนินการจัดโครงการอบรมเชิงปฏิบัติการพี่สอนน้อง ให้แก่นักเรียน...">
      ...
      <!-- 2. เรียนถึง -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">2. เรียนถึง :</label>

        <div class="flex-1">
          <input type="text" name="to_person" id="toPerson" data-spell-field="to_person"
            class="w-full border rounded-md p-2" placeholder="เรียนถึงเช่น ผู้อำนวยการโรงเรียนปราจีนกัลยาณี">
      ...
      <!-- 3. โรงเรียน / หน่วยงาน -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">3. โรงเรียน / หน่วยงาน :</label>

        <div class="flex-1">
          <input type="text" name="school_name" id="schoolName" data-spell-field="school_name"
            class="w-full border rounded-md p-2" placeholder="โรงเรียน/หน่วยงานเช่น โรงเรียนปราจีนกัลยาณี">
      ...
      <!-- 4. ชื่อโครงการหลัก -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">4. ชื่อโครงการหลัก :</label>
        <div class="flex-1">
          <input type="text" name="main_project" id="mainProject" data-spell-field="main_project"
            class="w-full border rounded-md p-2" placeholder="โครงการหลักเช่น โครงการอบรมเชิงปฏิบัติการพี่สอนน้อง">
      ...
      <!-- 5. ชื่อกิจกรรมย่อย / หัวข้ออบรม -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">5. ชื่อกิจกรรมย่อย :</label>
        <div class="flex-1">
          <input type="text" name="sub_activity" id="subActivity" data-spell-field="sub_activity"
            class="w-full border rounded-md p-2"
            placeholder="ชื่อกิจกรรมเช่น โครงการฝึกอบรมการใช้งานโปรแกรม Figma เบื้องต้น">
      ...
      <!-- 6. วัตถุประสงค์ / รายละเอียดกิจกรรม -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">6. วัตถุประสงค์ :</label>
        <div class="flex-1">
          <textarea name="objective_detail" id="objectiveDetail" data-spell-field="objective_detail" rows="3"
            class="w-full border rounded-md p-2"
            placeholder="วัตถุประสงค์เช่น เพื่อให้นักเรียนได้เรียนรู้หลักการของการเขียนโปรแกรมคอมพิวเตอร์เบื้องต้น..."></textarea>
      ...
      <!-- 7. กลุ่มเป้าหมาย -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">7. กลุ่มเป้าหมาย :</label>
        <div class="flex-1">
          <input type="text" name="target_group" id="targetGroup" data-spell-field="target_group"
            class="w-full border rounded-md p-2" placeholder="กลุ่มเป้าหมายเช่น นักเรียนระดับชั้นมัธยมศึกษา">
      ...
      <!-- 8. จำนวนผู้เข้าร่วม -->
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">8. จำนวนผู้เข้าร่วม :</label>
        <div class="flex">
      ...
      <div class="mb-6 flex items-start gap-4">
        ...
        <div class="space-y-3 text-gray-800">
          ...
          <div class="flex flex-wrap items-center gap-2">
            ...
            <input type="hidden" name="activity_period" id="activityPeriod">
          </div>
      ...
      <!-- 10. วิทยากร -->
      <div class="mb-6 flex items-start gap-4">
        <label class="lbl whitespace-nowrap w-40 pt-2">
          10. วิทยากร :
        </label>
        ...
        <div class="flex-1">
          <textarea name="lecturer_names" id="lecturerNames" data-spell-field="lecturer_names" rows="2"
            class="w-full border rounded-md p-2"
            placeholder="วิทยากรเช่น ผู้ช่วยศาสตราจารย์ ดร.สิวาลัย จินเจือ และทีมนักศึกษา"></textarea>
