...
?>
<!--ขออนุมัตินำนักศึกษาเดินทางไปเข้าร่วมงาน -->
<?php
session_start();
          ...
          ">
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="research_title" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น IT Fair 2024"></textarea>
            </div>

            <div class="mb-4 flex items-start gap-4">
                <label class="lbl whitespace-nowrap w-56 pt-2">
                    3. ชื่องานย่อย / งานที่อยู่ภายใต้ :
                </label>
                <textarea name="research_title" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น ICIT DAY 2024"></textarea>
            </div>

            <div class="mb-4 flex items-start gap-4">
                <label class="lbl text-gray-800 whitespace-nowrap pt-2">
                    4. วัตถุประสงค์ของการเข้าร่วมกิจกรรม :
                </label>
                <div class="w-full">
            ...
            <div class="mb-4 flex items-center gap-3">
                <label class="lbl whitespace-nowrap">
                    7. ชื่อ–นามสกุลอาจารย์ผู้ควบคุม :
                </label>
                <input type="text" name="advisor_name" class="flex-1 border rounded-md p-2">
            </div>
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <div class="flex gap-6">
                    <label class="flex items-center gap-2">
                        ...
                        อาจารย์ผู้ควบคุมและดูแลนักศึกษา
                    </label>
                    <label class="flex items-center gap-2">
            ...
            <div class="mb-4 flex items-center gap-3">
                <label class="lbl whitespace-nowrap w-56">
                    10. จำนวนนักศึกษาที่เข้าร่วมทั้งหมด :
                </label>

                <input type="number" name="student_count" id="studentCount" class="w-32 border rounded-md p-2 ml-6"
                    min="1">
            ...
            studentCountInput.addEventListener("input", () => {
                ...
                for (let i = 1; i <= count; i++) {
                    ...
                    row.className = "border rounded-md p-4 bg-gray-50";

                    row.innerHTML = `
            <div class="font-bold mb-2">นักศึกษาคนที่ ${i}</div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-2">
                <input type="text" name="student_name[]"
                    class="border rounded-md p-2"
                    placeholder="11. ชื่อ–นามสกุล">

                <input type="text" name="student_id[]"
                    class="border rounded-md p-2"
                    placeholder="12. รหัสประจำตัวนักศึกษา">
            </div>

            <div class="flex gap-6">
                <label class="flex items-center gap-2">
                    <input type="radio" name="student_role_${i}" value="participant">
                    ผู้เข้าร่วมกิจกรรม
                </label>
                <label class="flex items-center gap-2">
                    <input type="radio" name="student_role_${i}" value="brand">
                    Brand Ambassador
                </label>
                <label class="flex items-center gap-2">
                    <input type="radio" name="student_role_${i}" value="staff">
                    ผู้ช่วยจัดงาน
                </label>
            </div>
        `;
