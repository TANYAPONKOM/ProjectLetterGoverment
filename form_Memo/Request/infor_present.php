...
$CURRENT_SUB  = "หนังสือยินยอมให้นำเสนอผลงานทางวิชาการ";           // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง
?>
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="mb-4 flex items-center gap-4">
        ...
        <input type="text" name="full_name" class="flex border rounded-md p-2" read-only=""
      ...
      <div class="mb-4 flex items-start gap-4">
        ...
        <div class="flex-1">
          <textarea name="research_title" id="researchTitle" data-spell-field="research_title"
            class="w-full border rounded-md p-2" rows="2" placeholder="ระบุชื่อผลงานวิจัย"></textarea>
      ...
      <div class="mb-4 flex items-start gap-4">
        ...
        <div class="flex-1">
          <textarea name="conference_name" id="conferenceName" data-spell-field="conference_name"
            ...
            placeholder="เช่น International Conference on Information Technology"></textarea>
      ...
      <div class="mb-6 flex items-start gap-4">
        ...
        <div class="flex-1">
          <textarea name="conference_place" id="conferencePlace" data-spell-field="conference_place"
            class="w-full border rounded-md p-2" rows="2"
            placeholder="เช่น โรงแรม... กรุงเทพมหานคร ประเทศไทย / ประเทศญี่ปุ่น / รูปแบบออนไลน์"></textarea>
