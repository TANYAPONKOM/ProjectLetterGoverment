...
<body class="bg-gray-100">
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="mb-4 flex items-start gap-4">
        ...
        <div class="flex-1">
          <textarea name="thesis_title" id="thesisTitle" data-spell-field="thesis_title" rows="2"
      ...
      <div class="mb-4 flex items-start gap-4">
        ...
        <div class="flex-1">
          <textarea name="project_detail" id="projectDetail" data-spell-field="project_detail" rows="3"
            class="w-full border rounded-md p-2 shadow-sm"
            placeholder="ระบุวัตถุประสงค์ของการจัดทำปริญญานิพนธ์"></textarea>
      ...
      <div class="mb-6">
        ...
        <div class="mb-4 flex items-start gap-4">
          <label class="lbl text-gray-800 whitespace-nowrap w-64 pt-2" for="presentationType">
            5. ประเภทข้อมูลที่ขอ :
          </label>
        ...
        <div class="mb-4 flex items-start gap-4">
          ...
          <div class="flex-1">
            <textarea name="data_detail" id="dataDetail" data-spell-field="data_detail" rows="3"
        ...
        <div class="mb-4 flex items-start gap-4">
          ...
          <div class="flex-1">
            <input type="text" name="data_amount" id="dataAmount" data-spell-field="data_amount"
        ...
        <div class="mb-4 flex items-start gap-4">
          ...
          <div class="flex-1">
            <input type="text" name="student_name" id="studentName" data-spell-field="student_name"
              class="w-full border rounded-md p-2" placeholder="ชื่อ – นามสกุล">

            <div id="studentNameSpellBox" class="spell-box hidden"></div>
            <div id="studentNameSpellLoading" class="spell-loading hidden">
              <div class="spell-loading-row">
                <div class="spell-spinner"></div>
                <span>กำลังตรวจคำผิด...</span>
              </div>
        ...
        <div class="mb-4 flex items-start gap-4">
          ...
          <div class="flex-1">
            <input type="text" name="student_id" id="studentId" class="w-full border rounded-md p-2"
              placeholder="กรอกรหัสนักศึกษา 13 หลัก" inputmode="numeric" maxlength="13"
        ...
        <div class="mb-6 flex items-start gap-4">
          ...
          <div class="flex-1">
            <input type="tel" name="phone" id="phoneInput" class="w-full border rounded-md p-2"
              placeholder="กรอกเบอร์โทรศัพท์ 10 หลัก" inputmode="numeric" maxlength="10"
  ...
  function getSpellBoxByField(el) {
    ...
    if (el.id === "thesisTitle") return byId("thesisTitleSpellBox");
    if (el.id === "projectDetail") return byId("projectDetailSpellBox");
    if (el.id === "dataDetail") return byId("dataDetailSpellBox");
    if (el.id === "dataAmount") return byId("dataAmountSpellBox");
  ...
  function getSpellLoadingByField(el) {
    ...
    if (el.id === "thesisTitle") return byId("thesisTitleSpellLoading");
    if (el.id === "projectDetail") return byId("projectDetailSpellLoading");
    if (el.id === "dataDetail") return byId("dataDetailSpellLoading");
    if (el.id === "dataAmount") return byId("dataAmountSpellLoading");
  ...
  function validateRequiredAndNumbers() {
    ...
    if (!/^\d{13}$/.test(studentId?.value || "")) {
      setErr(studentId, true);
      alert("กรุณากรอกรหัสนักศึกษาให้ครบ 13 ตัวเลข");
      firstInvalid = firstInvalid || studentId;
    }

    if (!/^\d{10}$/.test(phoneInput?.value || "")) {
      setErr(phoneInput, true);
      alert("กรุณากรอกเบอร์โทรศัพท์ให้ครบ 10 ตัวเลข");
