...
$CURRENT_SUB  = "ขอประเมินสถานประกอบการสหกิจ(ประเมินเด็กสหกิจ)";           // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง
?>
<!--"ขอประเมินสถานประกอบการสหกิจ(ประเมินเด็กสหกิจ) ", "/Pro_letter/form_Memo/Request/infor_coop_evaluation.php" -->
<?php
session_start();
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="mb-4 flex items-start gap-1">
        <label class="lbl whitespace-nowrap w-48 pt-2">1. เรื่อง :</label>
        <div class="flex-1">
          <input type="text" name="subject" id="subjectInput" data-spell-field="subject"
            class="w-full border rounded-md p-2"
            value="ขอความอนุเคราะห์ตอบแบบประเมินและแบบสำรวจนักศึกษาปฏิบัติงานสหกิจศึกษา">
      ...
      <!-- 2. เรียนถึง -->
      <div class="mb-4 flex items-start gap-1">
        <label class="lbl whitespace-nowrap w-48 pt-2">2. เรียนถึง :</label>
        <div class="flex-1">
      ...
      <!-- 3. หน่วยงาน / สถานประกอบการ -->
      <div class="mb-4 flex items-start gap-1">
        <label class="lbl whitespace-nowrap w-48 pt-2">3. หน่วยงาน :</label>
        <div class="flex-1">
      ...
      <!-- 4. จำนวนนักศึกษาสหกิจศึกษา -->
      <div class="mb-4 flex items-start gap-1">
        <label class="lbl whitespace-nowrap w-48 pt-2">4. จำนวนนักศึกษา :</label>
        <div class="flex-1">
          <input type="number" name="student_count" id="studentCount" class="w-full border rounded-md p-2" min="1"
            max="50" placeholder="กรอกจำนวนนักศึกษา เช่น 2">
      ...
      <div class="mb-4 flex items-start gap-1">
        ...
        <div class="flex-1">
          <input type="email" name="evaluation_email" id="evaluationEmail" class="w-full border rounded-md p-2"
            value="it.kmutnb@itm.kmutnb.ac.th" placeholder="เช่น it.kmutnb@itm.kmutnb.ac.th">
        </div>
      </div>
