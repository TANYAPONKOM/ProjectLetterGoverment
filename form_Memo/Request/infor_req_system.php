...
?>
<!--ขออนุมัติตัวบุคลากรเดินทางไปนำเสนอ/หารือการพัฒนาระบบ -->
<?php
session_start();
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="mb-4 flex items-center gap-3">
        ...
        <input type="text" name="ref_org" class="flex-1 border rounded-md p-2">
      </div>
      ...
      <div class="mb-4 flex items-center gap-3">
        ...
        <input type="text" name="ref_no" class="flex-1 border rounded-md p-2">
      </div>

      <div class="mb-6 flex items-center gap-3">
        <label class="lbl whitespace-nowrap">
          4. วันที่หนังสืออ้างอิง :
        </label>

        <div class="relative">
          <input type="text" name="doc_date" id="docDate" class="border rounded-md p-2 w-44 pr-10 cursor-pointer"
      ...
      <!-- 5. เรื่องของหนังสืออ้างอิง -->
      <div class="mb-4 flex items-center gap-3">
        <label class="lbl whitespace-nowrap w-56">
          5. เรื่องของหนังสืออ้างอิง :
        </label>
        <input type="text" name="ref_subject" class="flex-1 border rounded-md p-2">
      </div>


      <div class="mb-4 flex items-start gap-4">
        <label class="lbl text-gray-800 whitespace-nowrap pt-2">
          6. วัตถุประสงค์ของการเข้าร่วมกิจกรรม :
        </label>
        <div class="w-full">
      ...
      <div class="mb-4 flex items-center gap-3">
        ...
        <input type="text" name="destination_org" class="flex-1 border rounded-md p-2">
      </div>
      ...
      <div class="mb-4 flex items-center gap-3">
        ...
        <input type="text" name="destination_province" class="flex-1 border rounded-md p-2">
      </div>
      ...
      <!-- 10. จำนวนบุคลากรที่เดินทางทั้งหมด -->
      <div class="mb-4 flex items-center gap-3">
        <label class="lbl whitespace-nowrap w-56">
          10. จำนวนบุคลากรที่เดินทางทั้งหมด :
        </label>

        <input type="number" name="student_count" id="studentCount" class="w-32 border rounded-md p-2 ml-6" min="1">
      ...
      studentCountInput.addEventListener("input", () => {
        ...
        for (let i = 1; i <= count; i++) {
          ...
          row.innerHTML = `
            <div class="font-bold mb-2">บุคลากรคนที่ ${i}</div>
