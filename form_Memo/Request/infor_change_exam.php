...
$CURRENT_SUB  = "ขอเปลี่ยนแปลงตารางสอบ (ของอาจารย์)";           // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง
?>
...
<body class="bg-gray-100">
  <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
    ...
    <div class="flex items-center space-x-4">
      ...
      <a href="/Pro_letter/form_Memo/Request/infor_change_exam.php">
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <!-- 1. ชื่อ–นามสกุลอาจารย์ผู้ขอ | ตำแหน่ง -->
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 items-end">
        <div class="flex items-center gap-3">
          <label class="lbl text-gray-800 whitespace-nowrap" for="fullname">1. ชื่อ–นามสกุลอาจารย์ผู้ขอ
            :</label>
      ...
      <div class="mb-4 flex items-center gap-4">
        ...
        <input type="number" name="subject_count" id="subjectCount" class="w-32 border rounded-md p-2" min="1"
          placeholder="เช่น 2">
      </div>


      <!-- 3. รายวิชาที่ขอเปลี่ยนแปลงตารางสอบ -->
      <div class="mb-6">
        <label class="lbl block mb-2">
          3. รายวิชาที่ขอเปลี่ยนแปลงตารางสอบ :
        </label>

        <div id="subjectList" class="space-y-3 ml-6"></div>
      </div>
      ...
      <div class="mb-4 flex items-center gap-4">
        ...
        <select name="semester" class="border rounded-md p-2 w-32">
        ...
        <input type="text" name="academic_year" class="border rounded-md p-2 w-32" placeholder="เช่น 2567">
      </div>

      <!-- 5. วันที่สอบเดิม / เวลาเดิม (กลางภาค) -->
      <div class="mb-6 flex items-center gap-4">
        <label class="lbl whitespace-nowrap w-56">
          5. วันที่สอบเดิม / เวลาเดิม :
        </label>
        ...
        <input type="text" name="missed_time" class="border rounded-md p-2 w-44" placeholder="เช่น 09:00 - 12:00">
      </div>
      ...
      <div class="mb-4 flex items-center gap-4">
        ...
        <input type="text" name="old_exam_room" class="flex-1 border rounded-md p-2"
          placeholder="เช่น อาคารเรียนรวม ห้อง IT-401">
      </div>

      <!-- 7. วันที่สอบใหม่ / เวลาใหม่ (ปลายภาค) -->
      <div class="mb-6 flex items-center gap-4">
        <label class="lbl whitespace-nowrap w-56">
          7. วันที่สอบใหม่ / เวลาใหม่ :
        </label>
      ...
      <div class="mb-4 flex items-center gap-4">
        ...
        <input type="text" name="new_exam_room" class="flex-1 border rounded-md p-2"
          placeholder="เช่น อาคารนวัตกรรม ห้องสอบกลาง">
      </div>

      <!-- 9. เหตุผลในการขอเปลี่ยนแปลงตารางสอบ -->
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const ROUTE_SUB = {
      ...
      "ขอสอนชดเชย (ของอาจารย์)": "#",
      "ขอห้องพักรับรอง (ของอาจารย์)": "/Pro_letter/user/infor_room_request.php",
