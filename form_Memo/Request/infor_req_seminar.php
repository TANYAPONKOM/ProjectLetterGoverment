...
?>
<!--ขออนุมัติตัวบุคคลเดินทางไปเข้าร่วมงานสัมมนา -->
<?php
session_start();
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 items-end">
        <div class="flex items-center gap-3">
          <label class="lbl text-gray-800 whitespace-nowrap" for="fullname">6. ชื่อ–นามสกุล
            :</label>
      ...
      <div class="mb-4 flex items-start gap-4">
        <label class="lbl text-gray-800 whitespace-nowrap pt-2">
          7. วัตถุประสงค์ในการเข้าร่วมงานสัมมนา :
        </label>
        <div class="w-full">
      ...
      <div class="mb-6">
        <div class="flex items-center gap-2 mb-2">
          <label class="lbl text-gray-800" for="amountInput">8.รวมยอดประมาณการค่าใช้จ่าย :</label>
