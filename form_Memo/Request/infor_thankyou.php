...
$CURRENT_SUB  = "หนังสือขอบคุณ (ของนักศึกษา)";      // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง
?>
...
<body class="bg-gray-100">
    <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="/Pro_letter/form_Memo/Request/infor_thankyou.php">
        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <div class="mb-4 flex items-center gap-4">
                <label class="lbl whitespace-nowrap w-40">
                    1. เรียนถึง :
                </label>
                <input type="text" name="to_person" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น ผู้จัดการ บริษัท … จำกัด">
            </div>
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="thank_topic" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น การสนับสนุนอุปกรณ์ / การให้ความอนุเคราะห์">
            </div>

            <!-- 3. ชื่อกิจกรรม / โครงการ -->
            <div class="mb-4 flex items-start gap-4">
                <label class="lbl whitespace-nowrap w-40 pt-2">
                    3. ชื่อกิจกรรม / โครงการ :
                </label>
                <textarea name="project_name" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น โครงการอบรมเชิงสัมมนา เรื่อง …"></textarea>
            </div>

            <!-- 4. วัตถุประสงค์ของการนำไปใช้ -->
            <div class="mb-4 flex items-start gap-4">
            ...
            <!-- 5. วันที่จัดกิจกรรม / ใช้งาน -->
            <div class="mb-6">
                <label class="lbl text-gray-800 block mb-2" id="dateLabel">5. วันที่จัดกิจกรรม / ใช้งาน :</label>
            ...
            <!-- 6. สถานที่จัดกิจกรรม / ใช้งาน -->
            <div class="mb-4 flex items-center gap-4">
                <label class="lbl whitespace-nowrap w-56">
                    6. สถานที่จัดกิจกรรม / ใช้งาน :
                </label>
                <input type="text" name="event_place" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี">
            </div>


            <!-- 7. ประเภทความอนุเคราะห์ -->
            <div class="mb-6">
                ...
                <div class="mb-4 flex items-start gap-4">
                    ...
                    <div class="w-full ml-1 space-y-1 mt-2" id="presentationType">
                        ...
                        <label class="flex items-center gap-2">
                            ...
                            สนับสนุนวัสดุการเรียนการสอน
                        </label>

                        <!-- ลดช่องว่างของบรรทัดนี้ -->
                        <div class="flex items-center gap-2">
                            <label class="flex items-center gap-2">
                                <input type="radio" name="support_type" value="other" class="accent-black"
                                    id="otherTypeRadio">
                                อื่น ๆ (ระบุ)
                            </label>
