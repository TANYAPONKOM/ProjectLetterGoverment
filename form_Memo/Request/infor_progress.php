    ...
    <form method="post" action="save_memo.php" id="memoForm">
        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <!-- 1–2 รอบรายงานความก้าวหน้า + เลขที่สัญญาวิจัย -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <!-- 1. รอบรายงานความก้าวหน้า -->
                <div class="flex items-center gap-3">
                    <label class="lbl whitespace-nowrap">
                        1. รอบรายงานความก้าวหน้า :
                    </label>
                    <input type="text" name="progress_round" class="flex-1 border rounded-md p-2"
                        placeholder="เช่น รอบ 6 เดือน">
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <input type="text" name="contract_no" class="flex-1 border rounded-md p-2"
                        placeholder="เช่น KMUTNB-66-BASIC-24">
                </div>
            </div>


            <!-- 2. วันที่จัดทำหนังสือ -->
            <div class="mb-6 flex items-center gap-3">
                ...
                <div class="relative">
                    <input type="text" name="doc_date" id="docDate"
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="research_title" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="ชื่อโครงการวิจัย"></textarea>
            </div>


            <div class="mb-4 flex items-center gap-4">
                <label class="lbl whitespace-nowrap w-56">
                    5. ร้อยละความก้าวหน้าของโครงการ :
                </label>

                <span class="ml-2">ร้อยละ</span>

                <input type="number" name="progress_percent" class="w-32 border rounded-md p-2" placeholder="เช่น 60">
            </div>


            <div class="mb-6 flex items-start gap-4">
                <label class="lbl whitespace-nowrap w-56 pt-1">
                    6. รายงานและเอกสารแนบ :
                </label>

                <div class="flex flex-col gap-2">
                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="attachments[]" value="F-BASIC-07" class="attach-check">
                        แบบรายงานความก้าวหน้างานวิจัย (F-BASIC-07)
                    </label>

                    <label class="flex items-center gap-2">
                        <input type="checkbox" name="attachments[]" value="F-BASIC-09" class="attach-check">
                        รายงานการเงิน (F-BASIC-09)
                    </label>
                </div>
            </div>
            <div class="flex items-center gap-3 ml-60 mt-2">
                <span>เอกสารแนบทั้งหมด จำนวน :</span>
                <input type="number" id="attachmentCount" class="w-24 border rounded-md p-2 bg-gray-50 text-gray-600"
                    value="0" readonly>
                <span>ฉบับ</span>
            </div>
            ...
            document.addEventListener("DOMContentLoaded", () => {
                const checkboxes = document.querySelectorAll(".attach-check");
                const countInput = document.getElementById("attachmentCount");
                ...
                // ผูก event
                checkboxes.forEach(cb => {
                    cb.addEventListener("change", updateAttachmentCount);
                });

                // 🔥 สำคัญ: นับทันทีตอนโหลดหน้า
