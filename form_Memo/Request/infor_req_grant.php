...
?>
<!--ขอส่งข้อเสนอโครงการวิจัยเพื่อขอรับทุนสนับสนุนนักวิจัยรุ่นใหม่ประจำปี  -->
<?php
session_start();
...
<body class="bg-gray-100">
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <!-- 3. ชื่อโครงการวิจัย (ภาษาไทย) -->
      <div class="mb-4 flex items-center gap-3">
        <label class="lbl whitespace-nowrap">
          3. ชื่อโครงการวิจัย (ภาษาไทย) :
        </label>
        <input type="text" name="project_th" class="flex-1 border rounded-md p-2">
      </div>

      <!-- 4. ชื่อโครงการวิจัย (ภาษาอังกฤษ) -->
      <div class="mb-4 flex items-center gap-3">
        <label class="lbl whitespace-nowrap">
          4. ชื่อโครงการวิจัย (ภาษาอังกฤษ) :
        </label>
        <input type="text" name="project_en" class="flex-1 border rounded-md p-2">
      </div>
      ...
      <div class="mb-6">
        ...
        <div class="mb-4 flex items-center gap-4">
          ...
          <input type="number" name="budget_amount" class="w-48 border rounded-md p-2" placeholder="เช่น 300000">
          <span>บาท</span>
        </div>
        ...
        <div class="mb-4 flex items-center gap-3">
          <label class="lbl whitespace-nowrap">
            7. ปีงบประมาณที่ดำเนินโครงการ :
          </label>
          <input type="text" name="fiscal_year" class="w-48 border rounded-md p-2" placeholder="เช่น 2568">
        </div>


        <!-- 9. แนบข้อเสนอโครงการวิจัย -->
        <div class="mb-6 flex items-center gap-4">
          <label class="lbl whitespace-nowrap w-56">
            8. แนบข้อเสนอโครงการวิจัย :
          </label>

          <span>จำนวน</span>
          <input type="number" name="attachment_count" class="w-24 border rounded-md p-2" placeholder="0">
          <span>ฉบับ</span>
        </div>
