...
<body class="bg-gray-100">
    <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="/Pro_letter/form_Memo/Request/infor_approve_pro.php">
        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="project_name" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น โครงการอบรมเชิงปฏิบัติการด้านเทคโนโลยีสารสนเทศ">
            </div>
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="project_objective" rows="3" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น เพื่อพัฒนาทักษะด้านเทคโนโลยีสารสนเทศให้แก่นักศึกษา"></textarea>
            </div>
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="project_date" id="projectDate"
                    class="border rounded-md p-2 w-48 cursor-pointer" placeholder="เลือกวันที่" readonly>
            </div>
            ...
            <div class="mb-4 flex items-center gap-4">
                ...
                <input type="text" name="room" class="border rounded-md p-2 w-48" placeholder="ห้อง">

                <span>อาคาร : </span>

                <input type="text" name="building" class="border rounded-md p-2 w-48" placeholder="อาคาร">
            </div>

            <div class="mb-6">
                <div class="flex items-center gap-2 mb-2">
                    <label class="lbl text-gray-800" for="amountInput">6.รวมยอดประมาณการค่าใช้จ่าย :</label>
