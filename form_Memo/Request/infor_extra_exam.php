...
$CURRENT_SUB  = "ขอสอบนอกตาราง (ของอาจารย์)";           // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง
?>
...
<body class="bg-gray-100">
    <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="/Pro_letter/form_Memo/Request/infor_extra_exam.php">
    ...
    <form method="post" action="save_memo.php" id="memoForm">
        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <!-- 5. เหตุผลที่ไม่สามารถจัดสอบตามตารางเดิมได้ -->
