...
?>
<!--ขออนุมัติตัวบุคคลเพื่อไปนำเสนอผลงานวิจัยในงานประชุมวิชาการระดับนานาชาติ -->
<?php
session_start();
        ...
        <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
          ...
          ">
            ...
            <div class="mb-4 flex items-center gap-4">
                <label class="lbl whitespace-nowrap w-56">3. บทบาทในงานประชุม :</label>
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <textarea name="research_title" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="ชื่อผลงานวิจัย"></textarea>
            </div>

            <div class="mb-4 flex items-start gap-4">
                <label class="lbl whitespace-nowrap w-56 pt-2">
                    5. ชื่องานประชุมวิชาการ :
                </label>
                <textarea name="conference_name" rows="2" class="flex-1 border rounded-md p-2"
                    placeholder="เช่น The 5th Asia Conference on Information Engineering (ACIE 2025)"></textarea>
            </div>
            ...
            <!-- 8. วันที่เริ่ม - วันที่สิ้นสุดงาน -->
