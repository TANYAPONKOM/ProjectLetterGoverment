<!--  ขออนุมัติจัดสอบนอกตาราง กลางภาคและปลายภาคเรียนที่ 2/2563 -->
<?php
session_start();
  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="content-block paragraph">
        ด้วยกระผม ผู้ช่วยศาสตราจารย์สมชัย เชียงพงษ์พันธ์
        สังกัดภาควิชาเทคโนโลยีสารสนเทศ
        คณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
        วิทยาเขตปราจีนบุรี
        มีความประสงค์ขออนุมัติจัดสอบนอกตาราง
        กลางภาคและปลายภาคเรียนที่ <span class="chip" contenteditable="true">
          2/2563</span>
        เนื่องจาก<span class="chip" contenteditable="true">
          เป็นกลุ่มนักศึกษาตกค้างจากหลักสูตรเก่าที่มีตารางสอบชนกับหลายวิชา</span>
        จึงมีความจำเป็นในการจัดสอบนอกตาราง
      </div>


      <!-- ย่อหน้า 2 -->
      <div class="content-block paragraph" style="text-indent:2.5cm;">
        โดยกระผมอาจารย์ผู้สอนจะเป็นผู้ดูแลรับผิดชอบการสอบด้วยตนเอง
        ทั้งนี้ วันและเวลาในการจัดสอบนอกตาราง
        จะทำการแจ้งให้ทราบภายหลัง
        จำนวน <span class="chip" contenteditable="true">
          2</span> วิชา ดังต่อไปนี้
      </div>

      <div class="content-block paragraph" style="text-indent:2.5cm;">
        1. วิชา <span class="chip" contenteditable="true">
          060213105 OBJECT-ORIENTED PROGRAMMING LAB. 1 (0-3)</span>

      </div>

      <div class="content-block paragraph" style="text-indent:2.5cm;">
        2. วิชา <span class="chip" contenteditable="true">
          060213291 COMPUTER GRAPHICS 3 (0-6)</span>
      </div>
