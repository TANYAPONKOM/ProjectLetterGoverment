<!--  ขอความอนุเคราะห์ดำเนินการเปลี่ยนแปลงตารางสอบปลายภาคประจำภาคเรียนที่ 2/2564 -->
<?php
session_start();
  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="doc-row">
        ...
        <div class="dot-line">
          <span class="chip" contenteditable="true">
            ขอความอนุเคราะห์ดำเนินการเปลี่ยนแปลงตารางสอบปลายภาค
      ...
      <div class="content-block paragraph">
        ...
        มีความประสงค์ขอความอนุเคราะห์ดำเนินการเปลี่ยนแปลงตารางสอบปลายภาค
        ประจำภาคเรียนที่ <span class="chip" contenteditable="true">2/2564</span>
        ของรายวิชา
        <span class="chip" contenteditable="true">
          060243104 OBJECT-ORIENTED PROGRAMMING 3(2-2)
        </span>
        เฉพาะในส่วนของการสอบภาคปฏิบัติ
        เพื่อให้นักศึกษาที่ตกค้างในรายวิชาดังกล่าว
        และมีตารางสอบชน สามารถลงทะเบียนเรียนครบตามหลักสูตรที่กำหนดได้
      </div>


      <div class="content-block paragraph" style="text-align:center; text-indent:0; font-weight:bold;">
        รายวิชาที่ขอเปลี่ยนแปลงตารางสอบปลายภาค ภาคเรียนที่ <span class="chip" contenteditable="true">2/2564</span>
      </div>


      <!-- ย่อหน้า 2 -->
      <table width="100%" cellpadding="6" cellspacing="0" style="border:2px solid black; border-collapse:collapse;">

        <tr align="center" style="background:#9ad85c; font-weight:bold;">
          <th rowspan="2" style="border:1px solid black;">ลำดับที่</th>
          <th rowspan="2" style="border:1px solid black;">รายวิชา</th>
          <th colspan="2" style="border:1px solid black;">กลางภาค 2/2564</th>
          <th colspan="2" style="border:1px solid black;">ปลายภาค 2/2564</th>
        </tr>
        <tr align="center" style="background:#9ad85c; font-weight:bold;">
          <th style="border:1px solid black;">เดิม</th>
          <th style="border:1px solid black;">ใหม่</th>
          <th style="border:1px solid black;">เดิม</th>
          <th style="border:1px solid black;">ใหม่</th>
        </tr>
        ...
        <tr align="center">
          ...
          <td style="border:1px solid black;">
            พ. 18/5/2565<br>9.00-12.00
          </td>
          <td style="border:1px solid black;">
            ส. 14/5/2565<br>9.00-12.00
          </td>
        </tr>
      </table>
