<!--  ขออนุมัติใช้ห้องปฏิบัติการคอมพิวเตอร์ B4-09 อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรมในวันหยุดราชการรวมทั้งขอเปิดใช้งานลิฟต์ด้านหลัง(ตรงหน้าห้องพยาบาล) เพื่อทำการสอนชดเชย วิชา 060223117 Object-oriented Programming -->
<?php
session_start();
  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="doc-row">
        ...
        <div class="dot-line">
          <span class="chip" contenteditable="true">
            ขออนุมัติใช้ห้องปฏิบัติการคอมพิวเตอร์ B4-09
      ...
      <div class="content-block paragraph">
        ด้วยข้าพเจ้า <span class="chip" contenteditable="true">ผู้ช่วยศาสตราจารย์นพดล บูรณ์กุศล</span>
        สังกัดภาควิชาเทคโนโลยีสารสนเทศ
        คณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
        วิทยาเขตปราจีนบุรี
        มีความประสงค์ขออนุมัติใช้<span class="chip" contenteditable="true">ห้องปฏิบัติการคอมพิวเตอร์
          B4-09</span>
        <span class="chip" contenteditable="true">อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรม</span>
        ในวันหยุดราชการ
        ในวัน<span class="chip" contenteditable="true"> พุธที่ 10 ธันวาคม 2568</span>
        เวลา <span class="chip" contenteditable="true"> 09.00 – 16.00 น.</span>
        เพื่อทำการสอนชดเชยในรายวิชา
        <span class="chip" contenteditable="true"> 060223117 Object-oriented Programming Lab L2, L3</span>
        ให้แก่นักศึกษาภาควิชาเทคโนโลยีสารสนเทศ
        จำนวน <span class="chip" contenteditable="true"> 100 </span>คน
      </div>
      ...
      <!-- ย่อหน้า 2 -->
      <div class="content-block paragraph">
        ในการนี้ ข้าพเจ้าจึงขออนุมัติใช้<span class="chip" contenteditable="true">ห้องปฏิบัติการคอมพิวเตอร์
          B4-09</span>
        <span class="chip" contenteditable="true">อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรม</span>
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
        วิทยาเขตปราจีนบุรี
        ในวันหยุดราชการ<span class="chip" contenteditable="true">รวมทั้งขอเปิดใช้งานลิฟต์ด้านหลัง
          (ตรงหน้าห้องพยาบาล)</span>
      ...
      <div class="signature-wrapper">
        <div class="signature-block" id="signatureBlock">
          <div class="sig-name">(ผู้ช่วยศาสตราจารย์นพดล บูรณ์กุศล)</div>
