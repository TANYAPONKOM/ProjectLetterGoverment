  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="content-block single">
        เรียน <span class="chip" contenteditable="true">นายแพทย์พัฒนา จินากลม
          นายแพทย์สำนักงานสาธารณสุขจังหวัดสระบุรี</span>
      </div>
      <br>
      <div class="content-block single">
        สิ่งที่ส่งมาด้วย แบบตอบรับนักศึกษาฝึกงาน จำนวน ๑ ฉบับ
      </div>
      ...
      <div class="content-block paragraph">
        ...
        ได้รับคำร้องจากนักศึกษาในโครงการสหกิจศึกษา
        ฉบับนี้ เพื่อให้นำเสนอต่อท่านพิจารณาให้ความอนุเคราะห์รับนักศึกษาจากสาขาวิชาเทคโนโลยีสารสนเทศ
        เข้ารับการฝึกงานในหน่วยงานของท่าน ระหว่างวันที่ ๑ เมษายน ๒๕๖๘
        ถึงวันที่ ๓๐ พฤษภาคม ๒๕๖๘ ทั้งนี้
        ภาควิชาได้เปิดดำเนินการสอนในหลักสูตรอุตสาหกรรมศาสตรบัณฑิต
        ตามหลักสูตรนักศึกษาต้องผ่านการฝึกงานกับสถานประกอบการไม่น้อยกว่า ๒๔๐ ชั่วโมง
        นอกจากนี้ เพื่อเสริมสร้างทักษะและประสบการณ์และฝึกฝนทักษะการทำงาน
        จากความรู้ที่เรียนมาได้เป็นอย่างดี
        ดังนั้น จึงขอความอนุเคราะห์มายังท่านในการรับนักศึกษาเข้าฝึกงานทางด้านเทคโนโลยีสารสนเทศ
      </div>


      <div class="content-block paragraph" style="text-indent:2.5cm;">
        ๑. นางสาวภัทร แก้วสุยา
        รหัสนักศึกษา ๖๖-๐๖๐๒๐๔-๒๐๓๘-๙
      </div>

      <div class="content-block paragraph" style="text-indent:2.5cm;">
        จึงเรียนมาเพื่อโปรดให้ความอนุเคราะห์ จะขอบคุณยิ่ง
      </div>
