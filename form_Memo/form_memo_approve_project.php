<!--  ขออนุมัติโครงการอบรมเชิงปฏิบัติการ เรื่อง “Vibe Coding Workshop Part I :
            การพัฒนา Front-End, Back-End และฐานข้อมูลด้วย AI Assist Application”
  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="content-block paragraph">
        ...
        มีความประสงค์ขออนุมัติดำเนินการจัดโครงการอบรมเชิงปฏิบัติการ
        เรื่อง<span class="chip" contenteditable="true"> “Vibe Coding Workshop Part I : การพัฒนา Front-End,
          Back-End
          และฐานข้อมูลด้วย</span><br><span class="chip" contenteditable="true"> AI Assist Application”</span>
        ในวันที่ <span class="chip" contenteditable="true">10 กันยายน 2568</span>
        ณ ห้อง <span class="chip" contenteditable="true">B4-21</span>
        อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
        โดยมีวัตถุประสงค์เพื่อเป็นการฝึกอบรมให้แก่บุคลากรและนักศึกษา
        คณะเทคโนโลยีและการจัดการอุตสาหกรรม
        รวมถึงบุคคลทั่วไปที่มีความสนใจเข้ารับการอบรม
        เพื่อให้มีความรู้ความเข้าใจเกี่ยวกับการพัฒนา
        Front-End, Back-End และฐานข้อมูลด้วย AI Assist Application
        และสามารถนำความรู้ที่ได้รับไปประยุกต์ใช้ในการเรียนการสอน
        การทำงาน และการศึกษาค้นคว้าหาความรู้ต่อไปในอนาคต
      </div>


      <!-- ย่อหน้า 2 -->
      <div class="content-block paragraph">
        ในการนี้ ภาควิชา ฯ จึงขออนุมัติดำเนินการจัดโครงการอบรมเชิงปฏิบัติการ
        เรื่อง “Vibe Coding Workshop Part I : การพัฒนา Front-End,
        Back-End
        และฐานข้อมูลด้วย AI Assist Application”
        ในวันที่ <span class="chip" contenteditable="true">10 กันยายน 2568</span>
        ณ ห้อง <span class="chip" contenteditable="true">B4-21</span>
        อาคารคณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
        โดยการจัดกิจกรรมดังกล่าวไม่มีค่าใช้จ่ายใด ๆ ทั้งสิ้น
        พร้อมรายชื่อคณะทำงานตามรายละเอียดโครงการแนบ
      </div>
      ...
      <div class="signature-wrapper">
        <div class="signature-block" id="signatureBlock">
          <div class="sig-name">(ผู้ช่วยศาสตราจารย์ ดร.สุพาภรณ์ ซิ้มเจริญ))</div>
