  ...
  <main class="page">
    <form id="updateForm" action="update_memo.php" method="post">
      ...
      <div class="content-block single">
        เรียน </span><span class="chip" contenteditable="true">ผู้จัดการ บริษัท เฮลท์ อัพ จำกัด</span>
      </div>


      <!-- ย่อหน้า 1 -->
      <div class="content-block paragraph">
        ตามที่ <span class="chip" contenteditable="true">บริษัท เฮลท์ อัพ จำกัด</span>
        ได้สนับสนุนชุดปฐมพยาบาลให้กับภาควิชาเทคโนโลยีสารสนเทศ
        คณะเทคโนโลยีและการจัดการอุตสาหกรรม มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ
        วิทยาเขตปราจีนบุรี เพื่อให้นักศึกษาใช้ในกิจกรรมโครงการ <span class="chip" contenteditable="true">IT3K
          งานพัฒนาสัมพันธ์อีสานพระจอมฯ
          ครั้งที่ ๑๙ </span>ระหว่างวันที่ <span class="chip" contenteditable="true">๙ – ๑๐ มีนาคม ๒๕๖๘
        </span>ณ
        <span class="chip" contenteditable="true">มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ</span>
      </div>
      ...
      <!-- ย่อหน้า 2 -->
      <div class="content-block paragraph">
        บัดนี้ ภาควิชาเทคโนโลยีสารสนเทศ คณะเทคโนโลยีและการจัดการอุตสาหกรรม
        มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าพระนครเหนือ วิทยาเขตปราจีนบุรี
        <span class="chip" contenteditable="true">ได้รับมอบชุดปฐมพยาบาลเรียบร้อยแล้ว</span>
        จึงขอขอบคุณในความอนุเคราะห์ดังกล่าวเป็นอย่างยิ่ง
