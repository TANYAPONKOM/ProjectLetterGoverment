<?php
 ...
 $CURRENT_MAIN="internal" ;
  $CURRENT_SUB="การเผยแพร่งานวิจัยและเบิกค่าตอบแทนการตีพิมพ์ (ของอาจารย์)" ; // ถ้าไม่มีหมวดย่อย ให้เว้นว่าง 
?>
...
<body class="bg-gray-100">
  <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
    ...
    <div class="flex items-center space-x-4">
      ...
      <a href="/Pro_letter/user/Request_6.php">
    ...
    <div class="w-[900px] mx-auto mt-16 mb-6 bg-white shadow-md rounded-md p-8" style="min-height: 1122px">
      ...
      <div class="relative mt-20">
        <div class="absolute right-0 bottom-0">
          <a href="../documents/form_memo_academic_6.php"
