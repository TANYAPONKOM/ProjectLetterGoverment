...
$CURRENT_SUB="ขอใช้อาคารวันหยุดราชการ (ของอาจารย์)" ; ?>
<!-- ภายใน บันทึกข้อความ -->
<?php
session_start();
...
<body class="bg-gray-100">
    <header class="bg-teal-500 text-white p-4 flex justify-between items-center shadow-md"
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="/Pro_letter/user/Request_2.php">
          ...
          ">
            ...
            <div class="mb-4 flex items-start gap-4">
                ...
                <div class="w-full flex items-center gap-6">
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" name="room" class="border rounded-md p-2 w-[150px] shadow-sm"
                            placeholder="เช่น B4-15" />
                    </div>
            ...
            <div class="relative mt-20">
                <div class="absolute right-0 bottom-0">
                    <a href="../documents/form_memo_room_request.php"
