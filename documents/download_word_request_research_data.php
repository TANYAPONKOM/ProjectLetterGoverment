...
addResearchDataRequestPage($phpWord, [
    ...
    'displaySubject' => wordThaiDigit($researchSubject),
    'displayToPerson' => wordThaiDigit($researchToPerson),
    ...
    'researchThesisTitle' => wordThaiDigit($researchThesisTitle),
    'researchAdvisorName' => wordThaiDigit($researchAdvisorName),
    'researchDataRequestText' => wordThaiDigit($researchDataRequestText !== '' ? $researchDataRequestText : 'ข้อมูล'),
