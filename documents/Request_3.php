...
$CURRENT_SUB = "ขอห้องพักรับรอง ";
?>
<!-- ขอห้องพักรับรอง (ของอาจารย์) Pro_letter/documents/Request_3.php-->
<?php
session_start();
...
<body class="bg-gray-100">
  ...
  <form method="post" action="save_memo.php" id="memoForm">
    ...
    <input type="hidden" name="target_form" value="Request_3.php">
    <input type="hidden" name="redirect_to" value="Request_3.php">
